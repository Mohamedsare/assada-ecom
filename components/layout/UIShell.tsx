      ...
      >
        ...
        {items.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-4 px-6 text-center">
            ...
            <button onClick={onClose} className="mt-2 bg-[#B8925A] text-white px-6 py-2.5 rounded-xl font-semibold text-sm hover:bg-[#9E7A45] transition-colors">
              Voir la boutique
            </button>
          </div>
        ) : (
          <>
            ...
            <div className="border-t border-gray-100 px-5 pt-4 pb-6 shrink-0 space-y-3 bg-white">
              ...
              <Link href="/checkout" onClick={onClose} className="w-full flex items-center justify-center gap-2 bg-[#B8925A] hover:bg-[#9E7A45] text-white py-3.5 rounded-xl font-bold text-sm transition-colors">
