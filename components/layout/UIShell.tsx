      ...
      >
        ...
        {items.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-4 px-6 text-center">
            ...
            <button onClick={onClose} className="mt-2 bg-[#2F9E44] text-white px-6 py-2.5 rounded-xl font-semibold text-sm btn-sweep hover:bg-[#237A34] transition-colors">
              Voir la boutique
            </button>
          </div>
        ) : (
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <div className="text-right">
                          <p className="text-sm font-bold text-[#0A2A52]">{formatPrice(unitPrice * item.quantity)}</p>
            ...
            <div className="border-t border-gray-100 px-5 pt-4 pb-6 shrink-0 space-y-3 bg-white">
              <div className="space-y-1.5 text-sm">
                ...
                <div className="flex justify-between text-[#64748B]">
                  ...
                  <span className={cn("font-medium", fee === 0 ? "text-[#0A2A52]" : "text-[#0A2A52]")}>{fee === 0 ? "Gratuite 🎉" : formatPrice(fee)}</span>
                </div>
              </div>
              ...
              <Link href="/checkout" onClick={onClose} className="w-full flex items-center justify-center gap-2 bg-[#2F9E44] btn-sweep hover:bg-[#237A34] text-white py-3.5 rounded-xl font-bold text-sm transition-colors">
                Passer la commande <ArrowRight size={16} />
              </Link>
              <Link href="/panier" onClick={onClose} className="w-full flex items-center justify-center gap-1 text-[#64748B] hover:text-[#0A2A52] py-2 text-sm font-medium transition-colors">
