...
export default function Header() {
  ...
  return (
    <header
      className={cn(
        "bg-white text-[#0A2A52] sticky top-0 z-50 shadow-sm border-b border-gray-100 transition-transform duration-300 ease-out",
        ...
        <div className="flex items-center justify-between min-h-16 lg:py-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex p-2 rounded-lg hover:bg-gray-100 hover:text-[#2F9E44] transition-colors"
            ...
            <button
              ...
              className="relative p-2 rounded-lg hover:bg-gray-100 hover:text-[#2F9E44] transition-colors"
              aria-label="Ouvrir le panier"
            >
              <ShoppingCart size={20} />
              {mounted && totalItems > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-[#2F9E44] text-[#0A2A52] text-xs rounded-full w-4 h-4 flex items-center justify-center font-bold">
            ...
            <Link
              href="/compte"
              className="hidden md:flex p-2 rounded-lg hover:bg-gray-100 hover:text-[#2F9E44] transition-colors"
        ...
        >
          ...
          <div className="shrink-0">
            <div className="flex items-center justify-between px-4 pt-4">
              ...
              <button
                ...
                className="p-1.5 rounded-lg text-[#0A2A52] hover:bg-gray-100 transition-colors"
              >
                <X size={20} />
              </button>
            </div>
              ...
              <div className="flex items-center gap-3">
                {SOCIAL_LINKS.map((s) => (
                  <a
                    ...
                    aria-label={s.label}
                    className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-[#0A2A52] hover:bg-green hover:border-green hover:text-[#0A2A52] transition-colors"
                  >
                    {s.label === "TikTok" && (
          ...
          <div className="shrink-0 p-4 border-t border-gray-100">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-[#2F9E44] text-white py-3 rounded-xl text-sm font-semibold btn-sweep hover:bg-[#237A34] transition-colors"
            >
