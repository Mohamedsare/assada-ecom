...
export default function Footer() {
  return (
    <footer className="bg-white text-text-secondary border-t border-gray-200 mt-16">
      <div className="max-w-7xl mx-auto px-4 pt-12 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm">
              <a href={`tel:${SITE_PHONE}`} className="flex items-center gap-2 hover:text-[#C9A063] transition-colors">
                <Phone size={14} />
                {SITE_PHONE}
              </a>
              <a href={`mailto:${SITE_EMAIL}`} className="flex items-center gap-2 hover:text-[#C9A063] transition-colors">
                <Mail size={14} />
                {SITE_EMAIL}
              </a>
          ...
          {/* Liens rapides */}
          <div>
            <h3 className="text-[#020B27] font-semibold mb-4">Liens rapides</h3>
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="hover:text-[#C9A063] transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Catégories */}
          <div>
            <h3 className="text-[#020B27] font-semibold mb-4">Catégories</h3>
            <ul className="space-y-2 text-sm">
              {[
          ...
          {/* Informations */}
          <div>
            <h3 className="text-[#020B27] font-semibold mb-4">Informations</h3>
            ...
            {/* Social */}
            <div>
              <h4 className="text-[#020B27] font-medium mb-3 text-sm">Suivez-nous</h4>
              <div className="flex gap-3">
                <Link href="https://www.tiktok.com/@ryta" target="_blank" rel="noopener noreferrer"
                  className="w-8 h-8 bg-gray-100 text-[#020B27] rounded-lg flex items-center justify-center hover:bg-[#B8925A] hover:text-white transition-colors">
                ...
                <Link href="https://www.facebook.com/ryta" target="_blank" rel="noopener noreferrer"
                  className="w-8 h-8 bg-gray-100 text-[#020B27] rounded-lg flex items-center justify-center hover:bg-[#B8925A] hover:text-white transition-colors">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="border-t border-gray-200 pt-5 text-center text-xs text-gray-500">
          <p>© {new Date().getFullYear()} RYTA — Tous droits réservés — Casablanca, Maroc</p>
        </div>
      </div>
    </footer>
  );
