    ...
    <div className="bg-[#0A2A52] text-white/80 text-xs py-2 px-4 hidden md:block border-b border-white/10">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href={`tel:${SITE_PHONE}`} className="flex items-center gap-1.5 hover:text-[#54B85E] transition-colors">
            <Phone size={12} />
            <span>{SITE_PHONE}</span>
          </Link>
        </div>

        <div className="flex items-center gap-1.5 text-[#54B85E] font-medium">
          <Truck size={13} />
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            aria-label="TikTok"
            className="hover:text-[#54B85E] transition-colors"
          >
