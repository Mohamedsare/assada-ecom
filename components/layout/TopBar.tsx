...
export default function TopBar() {
  return (
    <div className="bg-night text-white text-xs py-2 px-4 hidden md:block">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href={`tel:${SITE_PHONE}`} className="flex items-center gap-1.5 hover:text-[#22C55E] transition-colors">
            <Phone size={12} />
            <span>{SITE_PHONE}</span>
          </Link>
          <Link href={`mailto:${SITE_EMAIL}`} className="flex items-center gap-1.5 hover:text-[#22C55E] transition-colors">
            <Mail size={12} />
