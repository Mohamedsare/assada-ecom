      ...
      >
        ...
        {items.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-4 px-6 text-center">
            ...
            <button
              onClick={closeCartDrawer}
              className="mt-2 bg-[#16A34A] text-white px-6 py-2.5 rounded-xl font-semibold text-sm hover:bg-[#15803d] transition-colors"
            >
              Voir la boutique
            </button>
          </div>
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                          <button
                            ...
                            className="w-7 h-7 flex items-center justify-center hover:bg-gray-50 transition-colors text-[#0F172A]"
                            aria-label="Diminuer"
                          >
                            <Minus size={11} />
                          </button>
            ...
            <div className="border-t border-gray-100 px-5 pt-4 pb-6 shrink-0 space-y-3 bg-white">
              ...
              <div className="space-y-1.5 text-sm">
                ...
                <div className="flex justify-between text-[#64748B]">
                  ...
                  <span className={cn("font-medium", deliveryFee === 0 ? "text-[#16A34A]" : "text-[#0F172A]")}>
              ...
              <Link
                href="/checkout"
                onClick={closeCartDrawer}
                className="w-full flex items-center justify-center gap-2 bg-[#16A34A] hover:bg-[#15803d] text-white py-3.5 rounded-xl font-bold text-sm transition-colors"
              >
                Passer la commande
                <ArrowRight size={16} />
              </Link>
              ...
              <Link
                href="/panier"
                onClick={closeCartDrawer}
                className="w-full flex items-center justify-center gap-1 text-[#64748B] hover:text-[#0F172A] py-2 text-sm font-medium transition-colors"
              >
