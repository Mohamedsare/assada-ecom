...
const CATEGORIES = [
  { emoji: "👟", image: "/categories/chaussure-homme.jpeg",  label: "Chaussures Homme",  slug: "chaussures-homme"  },
  { emoji: "👠", image: "/categories/chaussure-femme.jpeg",  label: "Chaussures Femme",  slug: "chaussures-femme"  },
  { emoji: "👔", image: "/categories/vetement-homme.jpeg",   label: "Vêtements Homme",   slug: "vetements-homme"   },
  { emoji: "👗", image: "/categories/vetement-femme.jpeg",   label: "Vêtements Femme",   slug: "vetements-femme"   },
  { emoji: "📱", image: "/categories/electroniques.jpeg",    label: "Électroniques",     slug: "electroniques"     },
  { emoji: "💻", image: "/categories/pc.jpeg",               label: "PC & Accessoires",  slug: "pc-accessoires"    },
  { emoji: "⌚", image: "/categories/accessoire-homme.jpeg", label: "Accessoires Homme", slug: "accessoires-homme" },
  { emoji: "👜", image: "/categories/accessoire-femme.jpeg", label: "Accessoires Femme", slug: "accessoires-femme" },
];
...
const SOCIALS = [
  ...
  {
    label: "WhatsApp",
    href: getWhatsAppUrl("Bonjour Odm's Shopping, je suis intéressé par vos produits."),
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-[#0F172A]">
            Suivez <span className="text-green">Odm&apos;s Shopping</span>
          </h2>
