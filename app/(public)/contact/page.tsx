...
export const metadata: Metadata = {
  ...
  description:
    "Contactez RYTA : téléphone, email et WhatsApp. Service client 7j/7 pour vos commandes, livraisons et questions partout à Casablanca. Réponse rapide à Casablanca.",
  keywords: [
