    ...
    <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-4 flex gap-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 mt-3">
          {!approved ? (
            <button onClick={() => toggle(true)} disabled={pending} className="flex items-center gap-1 text-xs font-semibold bg-green text-[#020B27] px-3 py-1.5 rounded-lg hover:bg-[#15803D] disabled:opacity-60 transition-colors">
