  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-[#0A2A52]">Clients</h1>
      ...
      {customers.length === 0 ? (
        <div className="bg-white rounded-lg border border-gray-100 p-16 text-center">
          ...
          <p className="font-semibold text-[#0A2A52] mb-2">Aucun client</p>
    ...
    <tr className="hover:bg-gray-50 transition-colors">
      <td className="py-3 px-4 whitespace-nowrap">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-green rounded-full flex items-center justify-center text-[#0A2A52] font-bold text-xs shrink-0">{initials}</div>
          <div>
            <Link href={`/admin/clients/${client.id}`} className="text-sm font-medium text-[#0A2A52] hover:text-green transition-colors">{displayName}</Link>
      ...
      <td className="py-3 px-4 whitespace-nowrap"><span className="text-sm font-medium text-[#0A2A52]">{count}</span></td>
      <td className="py-3 px-4 whitespace-nowrap"><span className="text-sm font-medium text-[#0A2A52]">{total > 0 ? formatPrice(total) : "—"}</span></td>
      <td className="py-3 px-4 whitespace-nowrap">
        ...
        <div className="flex items-center gap-1">
          ...
          {client.phone && (
            <Link
              ...
              className="p-1.5 rounded-lg hover:bg-gray-100 text-gray-500 hover:text-[#2F9E44] transition-colors"
              title="WhatsApp"
            >
