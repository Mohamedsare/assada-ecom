    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-gray-100">
          ...
          <button type="button" onClick={save} disabled={pending} className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium bg-[#B8925A] text-[#020B27] hover:bg-[#9E7A45] transition-colors disabled:opacity-60">
...
function Toggle({ label, active, onClick }: { label: string; active: boolean; onClick: () => void }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`text-xs px-3 py-1.5 rounded-full font-medium border transition-colors ${active ? "bg-[#B8925A] text-[#020B27] border-[#B8925A]" : "bg-white text-[#64748B] border-gray-200 hover:border-gray-300"}`}
    >
      {label}
    </button>
  );
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={onClose}>
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-end gap-2 px-5 py-3 border-t border-gray-100 sticky bottom-0 bg-white">
          ...
          <Link href={`/admin/produits/${product.id}/modifier`} className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium bg-[#B8925A] text-[#020B27] hover:bg-[#9E7A45] transition-colors">
