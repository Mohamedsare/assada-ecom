      ...
      <form action={action} className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-lg border border-green/30 bg-green-50/50 p-4 flex items-center gap-3">
            ...
            <button
              ...
              className="shrink-0 flex items-center gap-1.5 text-xs font-semibold bg-green text-[#020B27] px-3 py-2 rounded-lg hover:bg-[#15803D] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          ...
          <Card title="Variantes (couleurs & tailles)">
            <p className="text-xs text-text-secondary -mt-1">
              Optionnel. Chaque variante a son propre stock et un ajustement de prix (en DH, positif ou négatif).
            </p>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-2">
            <button type="submit" disabled={pending} className="bg-green hover:bg-[#15803D] disabled:opacity-60 text-[#020B27] text-sm font-semibold px-5 py-3 rounded-lg transition-colors">
