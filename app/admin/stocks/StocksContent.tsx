    ...
    <tr className="hover:bg-gray-50 transition-colors">
      ...
      <td className="py-3 px-4">
        <div className="flex items-center gap-1.5">
          ...
          {dirty && (
            <button onClick={save} disabled={pending} className="text-xs font-semibold bg-green text-[#020B27] px-2.5 py-1.5 rounded-lg hover:bg-[#15803D] disabled:opacity-60 transition-colors">
              {pending ? "…" : "OK"}
            </button>
          )}
