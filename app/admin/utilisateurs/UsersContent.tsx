  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-[#0A2A52]">Utilisateurs admins</h1>
      ...
      {staff.length === 0 ? (
        <div className="bg-white rounded-lg border border-gray-100 p-16 text-center">
          ...
          <p className="font-semibold text-[#0A2A52] mb-1">Aucun membre du staff</p>
          <p className="text-text-secondary text-sm mb-5">Promouvez un client pour lui donner accès au back-office.</p>
          <button onClick={() => setPromoting(true)} className="bg-green btn-sweep hover:bg-[#237A34] text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors">
    ...
    <tr className="hover:bg-gray-50 transition-colors">
      <td className="py-3 px-4 whitespace-nowrap">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-[#0A2A52]">{name}{isSelf && <span className="text-[10px] text-green ml-1">(vous)</span>}</p>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          <h2 className="font-bold text-[#0A2A52]">Promouvoir un client</h2>
        ...
        <div className="p-5 space-y-4">
          {customers.length === 0 ? (
            ...
            <>
              ...
              <div>
                <label className="block text-sm font-medium text-[#0A2A52] mb-1.5">Rôle à attribuer</label>
                <select
                  value={role}
              ...
              <div className="flex gap-2 pt-1">
                <button
                  ...
                  className="flex items-center gap-2 bg-green btn-sweep hover:bg-[#237A34] disabled:opacity-50 disabled:cursor-not-allowed text-[#0A2A52] text-sm font-semibold px-5 py-2.5 rounded-lg transition-colors"
                >
