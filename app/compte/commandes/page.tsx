    ...
    <div>
      ...
      {orders.length === 0 ? (
        <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
          ...
          <p className="text-lg font-semibold text-[#0F172A] mb-2">Aucune commande</p>
              ...
              <div key={order.id} className="bg-white rounded-2xl border border-gray-100 p-5">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-bold text-[#0F172A]">{order.order_number}</h3>
                      <span
                  ...
                  <p className="font-bold text-[#16A34A]">{formatPrice(order.total_amount)}</p>
                </div>
                ...
                <div className="flex gap-3">
                  <Link
                    ...
                    className="flex items-center gap-1.5 text-sm border border-gray-200 px-4 py-2 rounded-xl hover:border-[#16A34A] hover:text-[#16A34A] transition-colors"
                  >
                    <Eye size={14} />
                    Détail
                  </Link>
